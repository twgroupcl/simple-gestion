<div class="input-group-overlay d-none d-lg-block mx-4">
    ...
    <input wire:keydown.enter="search" class="form-control prepended-form-control appended-form-control input-search" wire:model="query" type="text" placeholder="Buscar libros">
