<div class="dropdown-menu dropdown-menu-right" style="width: 20rem;">
    <div class="widget widget-cart px-3 pt-2 pb-3">
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center py-3">
            ...
            </div><a class="btn btn-outline-secondary btn-sm" href="{{ route('shopping-cart') }}">Ver carro<i class="czi-arrow-right ml-1 mr-n1"></i></a>
        </div><a class="btn btn-primary btn-sm btn-block" href="{{ route('checkout') }}"><i class="czi-card mr-2 font-size-base align-middle"></i>Checkout</a>
    </div>
</div>