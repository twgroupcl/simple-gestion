                    ...
                    <div class="pt-2 px-4 pr-lg-0 pl-xl-5">
                        ...
                        <div class="d-sm-flex justify-content-between align-items-center my-4 pb-3 border-bottom">
                            <div class="media media-ie-fix d-block d-sm-flex align-items-center text-center text-sm-left"><a
                                    ...
                                    style="width: 10rem;"><img src="img/marketplace/products/widget/01.jpg" alt="Product"></a>
                                <div class="media-body pt-2">
                                    <h3 class="product-title font-size-base mb-2"><a href="shop-single-v1.html">UI Isometric Devices Pack (PSD)</a></h3>
                            ...
                            <div class="pt-2 pt-sm-0 pl-sm-3 mx-auto mx-sm-0 text-center text-sm-left"
                                ...
                                <div class="form-group mb-0">
                                    <label class="font-weight-medium" for="quantity1">Project Devices Showcase (PSD)</label>
