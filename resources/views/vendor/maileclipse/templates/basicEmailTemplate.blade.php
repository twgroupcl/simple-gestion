                                        ...
                                        <table class="force-full-width"
                                            ...
                                            <tbody>
                                              ...
                                              <tr style="height: 263px;">
                                                <td style="height: 263px; width: 600px; background-color: #e67e23;">
                                                    <br /><img src="{{ asset($logo) }}" alt="" width="" height="" />
                                                </td>
                                              </tr> 
                                              @endif
                                                <tr style="height: 43px;">
                                                    <td class="headline"
                                                        style="height: 43px; width: 600px; background-color: #e67e23;">
                                                       <div style="margin-top: 10px;">{{ $title }}</div>
                                                    </td>
                                                </tr>
                                                <tr style="height: 76px;">
                                                    <td style="height: 76px; width: 600px; background-color: #e67e23;">
                                                        <center>
                                                    ...
                                                    <td style="height: 88px; width: 600px; background-color: #e67e23;">
                                                        <div>
                                                            ...
                                                            <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://" style="height:50px;v-text-anchor:middle;width:200px;" arcsize="8%" stroke="f" fillcolor="#178f8f">
                                                              <w:anchorlock/>
                                                              <center>
                                                            <![endif]--> <a style="background-color: #4b566b; border-radius: 4px; color: #ffffff; display: inline-block; font-family: Helvetica, Arial, sans-serif; font-size: 16px; font-weight: bold; line-height: 50px; text-align: center; text-decoration: none; width: 200px; -webkit-text-size-adjust: none;"
