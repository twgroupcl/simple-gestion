                                ...
                                <tr>
                                    <td align="center" valign="top">
                                        <table class="force-full-width" style="margin: 0 auto;" cellspacing="0"
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="font-size: 30px; text-align: center; background:#fa4239;"><br /><img
                                                            src="{{ asset('img/logo-pyme.png') }}"
                                                            alt="CRCP" /><br /><br /></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                                        ...
                                                        <center>
                                                           <div>
                                                                <p style="color: #ffffff;">
                                                                    Saludos cordiales, el siguiente correo electrónico es para notificarle que la 
                                                                    fecha de vencimiento del plan asociado a su tienda está próxima a cumplirse. </p>
                                                                <br>
                                                                <p style="color: #ffffff;">
                                                                    Para continuar disfrutando del servicio por favor registrar el pago del plan antes de su vencimiento el dia de mañana. 
                                                                </p>
                                                           </div>
                                                        </center>
                                                    </td>
