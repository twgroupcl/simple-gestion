                                        ...
                                        <table class="force-full-width" style="margin: 0 auto;" cellspacing="0"
                                            ...
                                            <tbody>
                                                                    ...
                                                                    @foreach ($cart->cart_items as $item)
                                                                        <tr>
                                                                            <td class="mobile-block"
                                                                                ...
                                                                                {{ $item->product->seller->visible_name }}</span>
                                                                                <br>
                                                                                <img src="{{ asset($item->product->getFirstImagePath()) }}"
                                                                                    width="15%"> <br />
                                                                                <span
                                                                                    style="font-size: 12px; word-wrap: break-word;">
                                                ...
                                                <tr style="height: 88px;">
                                                    <td style="height: 88px; width: 600px; background-color: #f5774e;">
                                                        <br /><br />
                                                        <div>
                                                            <a style="background-color: #4b566b; border-radius: 4px; color: #ffffff; display: inline-block; font-family: Helvetica, Arial, sans-serif; font-size: 16px; font-weight: bold; line-height: 50px; text-align: center; text-decoration: none; width: 200px; -webkit-text-size-adjust: none;" href="{{ $buttonLink }}">{{ $buttonText }}</a>
                                                        </div>
                                                        <br /><br />
                                                    </td>
                                                </tr>
