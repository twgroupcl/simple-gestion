                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="background-color: #f5774e;">
                                                        <center>
                                                           <div>
                                                               <p style="color: #ffffff;">Saludos cordiales, el siguiente correo electrónico es para notificarle que se ha realizado una suscripción con los siguientes datos:</p>
                                                               <table class="force-width-90" style="margin: 0 auto;" cellspacing="0" cellpadding="0">
                                                                <thead>
                                                                    <tr>
                                                                        <th width="20%"
