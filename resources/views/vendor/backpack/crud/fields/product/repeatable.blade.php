...
<div class="container-repeatable-elements">
  ...
  <button type="button" class="btn btn-outline-primary btn-sm ml-1 add-repeatable-element-button-clone">+ Clonar variacion anterior</button>
  ...
  @push('crud_fields_scripts')
      <script>
        ...
        function bpFieldInitRepeatableElement(element) {
            ...
            element.parent().find('.add-repeatable-element-button-clone').click(function(){
                newCloneRepeatableElement(container, field_group_clone);
            });
        ...
        function newRepeatableElement(container, field_group, values) {
         ...
         /**
         * Clone. Adds a new field group to the repeatable input. 
         */
        ...
        function clonePreviusValues() {
            ...
            fieldsToCopy.forEach( field => {
                let numberContainers = document.querySelectorAll(`input[data-repeatable-input-name=${field}]`).length
                let previousValue = document.querySelectorAll(`input[data-repeatable-input-name=${field}]`)[numberContainers-2].value;
                let actualField = document.querySelectorAll(`input[data-repeatable-input-name=${field}]`)[numberContainers-1];
                actualField.value = previousValue;
            })
