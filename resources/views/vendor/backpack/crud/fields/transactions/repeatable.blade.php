  ...
  @push('crud_fields_scripts')
      <script>
        ...
        function newRepeatableElement(container, field_group, values) {
            ...
            var repetibleContainer = $('div[data-repeatable-holder="json_transaction_details"]')    
    ...
    function addListenerToCheckboxCustom(element) {
        ...
        element.click(function () {
            if (element.prop('checked')) {
                element.parent().parent().siblings('.custom-document-name').show()
    ...
    function initialize() {
        let repetibleContainer = $('div[data-repeatable-holder="json_transaction_details"]')
        ...
        $(repetibleItems).each( function() {
            ...
            if (isCustomCheckbox.prop('checked')) {
                isCustomCheckbox.parent().parent().siblings('.custom-document-name').show()
                isCustomCheckbox.parent().parent().siblings('.document-select').hide()
            } else {
                isCustomCheckbox.parent().parent().siblings('.custom-document-name').hide()
                isCustomCheckbox.parent().parent().siblings('.document-select').show()
            }
        })
    }
