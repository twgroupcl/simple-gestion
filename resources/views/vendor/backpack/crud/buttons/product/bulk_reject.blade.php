...
<script>
  if (typeof bulkRejectEntries != 'function') {
    function bulkRejectEntries(button) {
        ...
        var message = "¿Esta seguro que desea rechazar :number libros?";
          ...
          $.ajax({
            ...
            success: function(result) {
              // Show an alert with the result
                    new Noty({
                    type: "success",
                    text: "<strong>Libros rechazados</strong><br>"+crud.checkedItems.length+" libros han sido rechazados."
                  }).show();
            ...
            error: function(result) {
              // Show an alert with the result
                    new Noty({
                    type: "danger",
                    text: "<strong>Algo fallo!</strong><br>Uno o mas libros no pudieron ser rechazados. Intenta nuevamente."
                  }).show();
            }
          });
        }
