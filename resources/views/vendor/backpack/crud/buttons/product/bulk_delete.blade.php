...
<script>
  if (typeof bulkDeleteEntries != 'function') {
    function bulkDeleteEntries(button) {
        ...
        var message = "¿Esta seguro que desea eliminar :number productos? Esta acción no podrá ser revertida";
          ...
          $.ajax({
            ...
            success: function(result) {
              // Show an alert with the result
                    new Noty({
                    type: "success",
                    text: "<strong>Productos eliminados</strong><br>"+crud.checkedItems.length+" productos han sido eliminados."
                  }).show();
            ...
            error: function(result) {
              // Show an alert with the result
                    new Noty({
                    type: "danger",
                    text: "<strong>Algo fallo!</strong><br>Uno o mas productos no pudieron ser eliminados. Intenta nuevamente."
                  }).show();
            }
          });
        }
