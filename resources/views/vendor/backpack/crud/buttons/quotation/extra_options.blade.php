<div class="btn-group">
    ...
    <div class="dropdown-menu">
        @if ($crud->hasAccess('generate_dte') && !($entry->quotation_status === 'EMITIDO' || $entry->quotation_status === 'FACTURADO') && !$entry->is_recurring)
        ...
        @if ($crud->hasAccess('duplicate') && !$entry->parent)
