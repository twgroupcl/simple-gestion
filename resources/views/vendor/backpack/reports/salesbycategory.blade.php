...
{{-- Tabla --}}
<div>
    <table id="sales-by-category-report" class="w-100 table table-hover table-bordered table-striped">
    ...
    <script> 
        ...
        ***********************************************/
        $(document).ready( function () {
            ...
            quotationTable = $('#sales-by-category-report').DataTable({
                language: spanish,
                ajax: {
                    url: '{{ route('report.sales_by_category.load-data') }}',
                    type: 'GET',
                    dataSrc: '',
                    data: {
                        from: function() {
        ...
        ***********************************************/
        ...
        $('#date-from, #date-to, #category').on('change', function () {
            filters.quotation_status = $('#category').val();
