...
@can('generalsettings.list')
        <li class='nav-item'><a class='nav-link' href='{{ backpack_url('generalsettings') }}'><i class='nav-icon la la-tools'></i> Configuración general</a></li>
@endcan
...
@canany(['product.list'])
<li class="nav-item nav-dropdown">
	<a class="nav-link nav-dropdown-toggle" href="#"><i class="nav-icon la la-box"></i> Libros</a>
	<ul class="nav-dropdown-items">
        @can('product.list')
        <li class='nav-item'><a class='nav-link' href='{{ backpack_url('product') }}'><i class='nav-icon la la-box'></i> Libros</a></li>
        @endcan
...
@endcanany
@canany(['plans.list'])
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('plans') }}'><i class="nav-icon la la-list"></i> Planes</a></li>
@endcanany
