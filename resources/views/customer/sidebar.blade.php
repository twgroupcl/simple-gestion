...
<aside class="col-lg-4 pt-4 pt-lg-0">
    <div class="cz-sidebar-static rounded-lg box-shadow-lg px-0 pb-0 mb-5 mb-lg-0">
        ...
        <ul class="list-unstyled mb-0">
            <li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3 {{ route('customer.order') == url()->current() ? 'active' : '' }}" href="{{ route('customer.order') }}"><i class="czi-bag opacity-60 mr-2"></i>Órdenes<span class="font-size-sm text-muted ml-auto"></span></a></li>
        ...
        <ul class="list-unstyled mb-0">
            ...
            <li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3 {{ route('customer.subscription') == url()->current() ? 'active' : '' }}" href="{{ route('customer.subscription') }}"><i class="czi-edit opacity-60 mr-2"></i>Suscripción</a></li>
