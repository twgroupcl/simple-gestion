...
class CustomerRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'addresses_data_validation.*.subnumber' => 'required',
            'addresses_data_validation.*.commune_id' => 'required|int|exists:communes,id',
            'addresses_data_validation.*.uid' => ['required', 'string', $rutRule],
            'addresses_data_validation.*.first_name' => 'required|string',
            'addresses_data_validation.*.last_name' => 'required|string',
            'addresses_data_validation.*.email' => 'required|email',
            ...
            'bank_data_validation.*.rut' => ['required', 'string', $rutRule],
