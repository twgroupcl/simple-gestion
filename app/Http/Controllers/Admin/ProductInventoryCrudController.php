...
class ProductInventoryCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\ProductInventory::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/productinventory');
        CRUD::setEntityNameStrings('productinventory', 'product_inventories');
    }
